...
//
// Decision-tree mutation chance used to live here as a per-organism
// trait; it's now a global constant (config.ChanceToMutateDecisionTree)
// applied identically to every organism.
type Traits struct {
